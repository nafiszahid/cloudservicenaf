...
print os.system('sudo virt-install --cdrom /root/Downloads/ubuntu-14.04-desktop-amd64.iso --ram '+dirram+' --vcpu '+dircpu+' --nodisk --name '+dirname+' --graphics vnc,port=5950,listen=0.0.0.0 &')
